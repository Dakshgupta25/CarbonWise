...
FEATURE_COLUMNS = ['Vehicle_Monthly_Distance_Km'
 'Frequency_of_Traveling_by_Air_very frequently' 'Vehicle_Type_electric'
 'How_Many_New_Clothes_Monthly' 'Waste_Bag_Weekly_Count' 'Sex_male'
 'Frequency_of_Traveling_by_Air_never' 'Body_Type_obese'
 'Vehicle_Type_hybrid' 'Frequency_of_Traveling_by_Air_rarely']
# [
